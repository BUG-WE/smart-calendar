...
extern void Chinese_Show_one(uint16_t x, uint16_t y,  uint16_t num, uint16_t size,uint32_t fColor, uint32_t bColor);
extern void TFTLCD_ShowChinese(uint32_t x,uint32_t y,char *p,uint32_t fColor, uint32_t bColor);
extern void Number_Show_one(uint16_t x, uint16_t y,  uint16_t num, uint16_t size,uint32_t fColor, uint32_t bColor);
//extern void LCD_DispEnCh(uint16_t x, uint16_t y,char *pstr, uint32_t color);
